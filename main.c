...
/* Private user code ---------------------------------------------------------*/
/* USER CODE BEGIN 0 */
typedef enum {IDLE, TRANSMIT} Mode;
Mode current_mode = IDLE;
uint8_t button_one_pressed = 0;
uint8_t button_two_pressed = 0;
...
int main(void)
{
  ...
  void transmit_mode(void);
   ...
   void handle_button(void){
    if(HAL_GPIO_ReadPin(Button0_GPIO_Port, Button0_Pin) == Button0_Pin_RESET){
      button_one_pressed = 1;
    }

    if if(HAL_GPIO_ReadPin(Button2_GPIO_Port, Button2_Pin) == Button2_Pinn_RESET){
        button_two_pressed = 1;
   }


  void idle_mode(void){
    HAL_GPIO_WritePin(LED0_GPIO_Port, LED0_Pin, LED0_Pin_RESET);//led d0 off
    HAL_GPIO_WritePin(LED1_GPIO_Port, LED1_Pin, LED1_Pin_SET);//led d1 on
    HAL_GPIO_WritePin(LED2_GPIO_Port, LED2_Pin, LED1_Pin_SET);//led d2 on
  ...
  void transmit_mode(void){
    HAL_GPIO_WritePin(LED0_GPIO_Port, LED0_Pin, LED0_Pin_RESET);//led d0 off
    HAL_GPIO_WritePin(LED2_GPIO_Port, LED2_Pin, LED2_Pin_SET);//led d2 on
